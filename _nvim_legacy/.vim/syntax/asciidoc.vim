...
highlight asciidocHLabel term=bold ctermfg=darkgreen cterm=bold guifg=darkgreen gui=bold
...
highlight asciidocListLabel term=bold ctermfg=darkgreen cterm=bold guifg=darkgreen gui=bold
...
"Comments
highlight asciidocCommentBlock term=standout ctermfg=blue guifg=blue
highlight asciidocCommentLine term=standout ctermfg=blue guifg=blue
...
map <silent><leader>b :!chromium-browser "%:p:r.html" 2> /dev/null & disown<CR>

nnoremap Q gq}

iab :::/ ifdef::backend-slidy2[////]+********+ifdef::backend-slidy2[////]D----i


iab 2col 'title'[cols="a,a",grid="none",frame="none"]\|====\|[float]* foo* bar.2+\|[float]* foo2* bar2\|====Di

iab <<<s ifdef::backend-slidy2[<<<]DI

iab ifds ifdef::backend-slidy2[]endif::backend-slidy2[]D--I
