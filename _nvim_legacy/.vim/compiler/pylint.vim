...
" 's/^C/3 C /' |sort -k1,3
"CompilerSet makeprg=(echo\ '[%]';pylint\ -i\ y\ '%'\\\|grep\ -e\ \'^[WECYR]\'\\\|sed\ -e\ \'s/^E/1\ E\ /\'\ -e\ \'s/^W/2\ W\ /\'\ -e\ \'s/^C/3\ C\ /\'\ -e\'s/^R/4\ R\ /\'\ -e\ \'s/:[\.\ _a-zA-Z]*:/:/g\'\ -e\ \'s/^Y/0\ Y/\'\ \\\|sort\ -k1,4\ \\\|sed\ -e\ \'s/^0\ //\')
CompilerSet makeprg=(echo\ '[%]';pylintpep8\ '%'\\\|grep\ -e\ \'^[WECYR]\'\\\|sed\ -e\ \'s/^E/1\ E\ /\'\ -e\ \'s/^W/2\ W\ /\'\ -e\ \'s/^C/3\ C\ /\'\ -e\'s/^R/4\ R\ /\'\ -e\ \'s/:[\.\ _a-zA-Z]*:/:/g\'\ -e\ \'s/^Y/0\ Y/\'\ \\\|sort\ -k1\ -n\ -k4\ \\\|sed\ -e\ \'s/^0\ //\')
